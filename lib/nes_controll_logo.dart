...
class NesControllLogo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: NesLogoPainter(),
    );
  }
}

class NesLogoPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    final rRectDigitalControllerHPath = Path()
      ..addRRect(rRectDigitalControllerH);
    final rRectDigitalControllerVPath = Path()
      ..addRRect(rRectDigitalControllerV);
